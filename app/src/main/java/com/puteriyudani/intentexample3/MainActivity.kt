package com.puteriyudani.intentexample3
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_send_data.setOnClickListener {
            ...
            m_intent.putExtra("main_activity_data", m_bundle) //Menambahkan data ke Intent menggunakan method putExtra
            startActivityForResult(m_intent, SECOND_ACTIVITY) //Menjalankan activity dengan memanggil method startActivityForResult
        }
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        super.onActivityResult(requestCode, resultCode, data) //hasil dapat diterima melalui fungsi callback onActivityResult
